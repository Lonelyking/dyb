...
brucebots = Client('link shortener bot',
             api_id=API_ID,
             api_hash=API_HASH,
             bot_token=BOT_TOKEN,
             workers=100)
...
async def start(bot, message):
    await message.reply(
        f"**Hello {message.chat.first_name} Bro!**\n\n"
        "I am  Link Shortener bot. Just send me link and get short link, You can also send multiple links seperated by a space or enter.\n\n")


@brucebots.on_message(filters.private & filters.text & filters.incoming)
